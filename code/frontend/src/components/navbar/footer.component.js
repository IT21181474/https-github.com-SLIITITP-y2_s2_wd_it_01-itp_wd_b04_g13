function footer() {
    return (
        <footer class="container max-w-7xl mx-auto px-4 font-body undefined">
            <div class="fixed mt-7  w-full bg-dark left-0 bottom-0  px-4 py-2 mx-auto space-y-8  sm:px-6 lg:px-8">
                <nav class="flex flex-wrap justify-center -mx-5 -my-2">
                    ...
                    <div class="px-5 py-2">
                        <a href="/" class="leading-6 text-white no-underline font-bold  hover:text-gray-900">
                            About us
                        </a>
